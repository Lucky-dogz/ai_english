    ...
    <div id="rec">
      ...
      <div class="voice-input-button-wrapper">
        <voice-input-button
          v-model="result"
          app-id="1edc4b79"
          api-key="4fea9c2cfee8c9fcbc2d9bccf080a33e"
          api-secret="NTczMDg5ZTUxNDI3MjBkNDlmZGUxZmMw"
        ...
        >
          <template #no-speak>没听清您说的什么</template>
        </voice-input-button>
      </div>
    </div>
  </div>
...
export default {
  name: "VoiceRec",
  components: { HEader, voiceInputButton },
  data() {
    return {
      title: "语音识别",
      result: "请点击语音开始识别...",
  ...
  methods: {
    ...
    //             signatureSha = CryptoJS.HmacSHA256(
    //               signatureOrigin,
    //               this.apiSecret
    //             ),
